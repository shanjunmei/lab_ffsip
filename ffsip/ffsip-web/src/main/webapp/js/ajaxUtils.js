...
(function($) {
     ...
     */
    var ajaxRequest=function(callBackFn,baseUrl,jsonData,baseData) {
        $.ajax({
            url:baseUrl,
            crossDomain:true,
            dataType:'jsonp',
    ...
    $.extend({
    	frontEngineAjax: {
            ...
            ajaxRequest: function(callBackFn,baseUrl,jsonData,baseData) {
                return ajaxRequest(callBackFn,baseUrl,jsonData,baseData);
            }
        }
    });
