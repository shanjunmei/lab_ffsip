...
+ function($) {
  ...
  var hide = function(callback, className) {
	var $selector = ($.type(className) != 'undefined') ? $('.' + className) : $(".weui_toast_visible");
    $(".weui_mask_transparent").remove();
    $selector.removeClass("weui_toast_visible").transitionEnd(function() {
      var $this = $(this);
      $this.remove();
  ...
  $.showLoading = function(text, className) {
    ...
    show(html, 'weui_loading_toast ' + className);
  }
