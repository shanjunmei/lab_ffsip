...
//var UEDITOR_HOME_URL = PATH_BASE + '/lib/ueditor/';
...
requirejs.config({
	...
	paths: {
		...
		'jq/datetimepicker': PATH_JQUI_JS + '/addon/time/i18n/datetimepicker-zh-CN',
	...
	shim: {
		...
		'jq/datetimepicker': {deps: [PATH_JQUI_JS + '/addon/time/datetimepicker.js', 'css!'+ PATH_JQUI_JS +'/addon/time/datetimepicker.css']},
