...
FFZX.openPageTab = function(tabID){
	
	top.postMessage(curIframeID + ',pageTab:#' + tabID, curIframeObj[1]);
}
...
function iframeFullPage(url){
	...
	var iframe = '<iframe id="iframeFullPage" frameborder="0" scrolling="auto" src="'+ url +'" name="iframeFullPage,'+window.location.href+'" class="iframeFullPage" style="height:'+ parent.$('iframe').height() +'px">';
	$('body').append(iframe);
}
