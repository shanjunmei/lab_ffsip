...
<form id="find-page-orderby-form" action="${BasePath !}/Menu/queryData.do" method="post" class="ff-form">
    ...
    <a href="javascript:iframeFullPage('${BasePath !}/Menu/toForm.do')" class="ff-btn sm"><i class="fa fa-plus"></i>&nbsp;&nbsp;添加</a>
...
<script type="text/javascript" src="${BasePath !}/asset/js/ffsip/Menu/Menu_list.js?v=${ver !}"></script>
<style>.clm_action {
    ...
    $(document).ready(function () {
        ...
        ffzx.ui(['datatable'], function () {
            ...
            var dt_role_list = new initDataTable({
                div_id: 'data_list',
                url: rootPath + "/Menu/queryData.do",
                columns: [
